...
ggplot(state_covid_combined, aes(x = date, y = combined_rolling_mean)) +
  geom_line(color = "purple", size = 1.2) + 
  facet_wrap(~ state, scales = "free_x") +  
  labs(
    title = "7-Day Rolling Average of New COVID-19 Cases Per Capita (2020-2022)",
    x = "Date",
    y = "7-Day Rolling Mean of New Cases Per Capita"
  ) +
  theme_minimal() + 
  theme(
...
Scaling the 7-day rolling mean by the population shows that all of the states have relative similar data. At first, New York looked much worse than the others, but we can see in this adjusted graph, that was only because New York has such a large population.
